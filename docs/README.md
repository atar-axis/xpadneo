...
This feature is disabled by default so Guide-button shortcuts in Steam and other software continue to work. Re-enable
it with the module parameter `disable_shift_mode=0` if you want xpadneo to intercept Guide+face-button combinations
